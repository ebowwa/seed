...
var TmuxTool = /** @class */ (function (_super) {
    __extends(TmuxTool, _super);
    function TmuxTool() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "tmux";
        _this.description = "Terminal multiplexer for persistent sessions";
        return _this;
    }
    TmuxTool.prototype.isApplicable = function (env) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // Tmux is useful for VPS and Linux environments
                return [2 /*return*/, env.os === "linux" || env.os === "macos"];
            });
        });
    };
    TmuxTool.prototype.checkInstalled = function (env) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.commandExists("tmux")];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    TmuxTool.prototype.install = function (env) {
        return __awaiter(this, void 0, void 0, function () {
            var installCmd, proc, exitCode, brewProc, brewExitCode;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("  Installing ".concat(this.name, "..."));
                        if (!(env.os === "linux")) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2:
                        if (!(env.os === "macos")) return [3 /*break*/, 4];
                        // macOS: Try Homebrew first
                        console.log("  Trying Homebrew installation (macOS)...");
                        brewProc = Bun.spawn(["brew", "install", "tmux"], {
                            stdout: "inherit",
                            stderr: "inherit",
                        });
